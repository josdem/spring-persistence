...
TIP: `PersistenceExceptionTranslationPostProcessor` es un post procesador de beans el cual agrega un advisor a cualquier bean anotado con @Repository, de tal forma que, cualquier excepción de cualqueir plataforma de acceso a datos es cachada y relanzada por una excepción No Checada de Spring.
...
NOTE: ¡Es tu turno! Implementa los DAO's faltantes, revisa los mapeos de Hibernate pues están icnompletos.
